...
no_of_images = 3
image_names = ["action_shot_33.jpg",  "action_shot_43.jpg", "action_shot_50.jpg"]

images = []
for i in range(no_of_images):
    image_path = os.path.join("actionshot", image_names[i])
...
cv2.imwrite("actionshot/matched_points.jpg", matched_points)
cv2.imwrite("actionshot/panoram1a_image.jpg", result)
